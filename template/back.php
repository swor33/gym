...
<body>
      <section id="workout" class="workout view">
        ...
        <div class="content">
            ...
            <div class="frame">
                <div class="box">
                    <img src="../image/back2.gif" alt="">
                </div>
                <div class="title">Scap push-up</div>
            ...
            <div class="frame">
                <div class="box">
                    <img src="../image/back3.gif" alt="">
                </div>
                <div class="title">Pull-up</div>
            ...
            <div class="frame">
                <div class="box">
                    <img src="../image/back4.gif" alt="">
                </div>
                <div class="title">Wall walk</div>
            ...
            <div class="frame">
                <div class="box">
                    <img src="../image/back5.gif" alt="">
                </div>
                <div class="title">Dumbbell bent-over row</div>
